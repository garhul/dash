...
// export type ruleActionListProps = {
//   topicOpts: [name: string, value: string][];
...
//   schedule: string;
// }
// function Rule({ name, schedule }: ruleProps) {
//   return (
...
//   const rules = props.rules.map((s, i: number) => (<Rule {...s} key={`ruleList_${i}`} />));
//   return (
//     <Container>
//       {rules}
//     </Container>
